...
/*
    ###################################################################################
    PureHwVideoDiscoverOpenGL_4_3.h
...
/**
    Pure OpenGL 4.3 capabilities class.
*/
class PureHwVideoDiscoverOpenGL_4_3 :
    public PureHwVideoDiscoverOpenGLbase
{
#ifdef PURE_CLASS_IS_INCLUDED_NOTIFICATION
#pragma message("  PureHwVideoDiscoverOpenGL_4_3 is included")
#endif
...
public:
    ...
    virtual ~PureHwVideoDiscoverOpenGL_4_3() {};
...
protected:
    ...
    PureHwVideoDiscoverOpenGL_4_3(const PureHwVideoDiscoverOpenGL_4_3&) {};
    PureHwVideoDiscoverOpenGL_4_3& operator=(const PureHwVideoDiscoverOpenGL_4_3&) { return *this; };
