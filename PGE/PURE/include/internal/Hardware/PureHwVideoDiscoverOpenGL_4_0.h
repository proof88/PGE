...
/*
    ###################################################################################
    PureHwVideoDiscoverOpenGL_4_0.h
...
/**
    Pure OpenGL 4.0 capabilities class.
*/
class PureHwVideoDiscoverOpenGL_4_0 :
    public PureHwVideoDiscoverOpenGLbase
{
#ifdef PURE_CLASS_IS_INCLUDED_NOTIFICATION
#pragma message("  PureHwVideoDiscoverOpenGL_4_0 is included")
#endif
...
public:
    ...
    virtual ~PureHwVideoDiscoverOpenGL_4_0() {};
...
protected:
    ...
    PureHwVideoDiscoverOpenGL_4_0(const PureHwVideoDiscoverOpenGL_4_0&) {};
    PureHwVideoDiscoverOpenGL_4_0& operator=(const PureHwVideoDiscoverOpenGL_4_0&) { return *this; };
