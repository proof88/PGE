...
/*
    ###################################################################################
    PureHwVideoDiscoverOpenGL_4_1.h
...
/**
    Pure OpenGL 4.1 capabilities class.
*/
class PureHwVideoDiscoverOpenGL_4_1 :
    public PureHwVideoDiscoverOpenGLbase
{
#ifdef PURE_CLASS_IS_INCLUDED_NOTIFICATION
#pragma message("  PureHwVideoDiscoverOpenGL_4_1 is included")
#endif
...
public:
    ...
    virtual ~PureHwVideoDiscoverOpenGL_4_1() {};
...
protected:
    ...
    PureHwVideoDiscoverOpenGL_4_1(const PureHwVideoDiscoverOpenGL_4_1&) {};
    PureHwVideoDiscoverOpenGL_4_1& operator=(const PureHwVideoDiscoverOpenGL_4_1&) { return *this; };
