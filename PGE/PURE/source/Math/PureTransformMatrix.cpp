...
*/
void PureTransformMatrix::SetTranslation(TPureFloat x, TPureFloat y, TPureFloat z)
{
    SetIdentity();
    mat[0][3] = x;
    mat[1][3] = y;
...
*/
void PureTransformMatrix::SetScale(TPureFloat x, TPureFloat y, TPureFloat z)
{
    SetZero();
    mat[0][0] = x;
    mat[1][1] = y;
    ...
    const PureVector& vUp)
{
    ...
    */
    ...
    PureVector vForwardFromTargetAndPos = vTarget - vPos;
    vForwardFromTargetAndPos.Normalize();

    PureVector vAltUp = vUp;
    ...
    PureVector vRightFromForwardAndUp = vAltUp ^ vForwardFromTargetAndPos;
    vRightFromForwardAndUp.Normalize();

    PureVector vUpFromRightAndForward = vForwardFromTargetAndPos ^ vRightFromForwardAndUp;
...
PureTransformMatrix PureTransformMatrix::matZero(PURE_MATRIX_ZERO);            // Our static zero matrix.
PureTransformMatrix PureTransformMatrix::matIdentity(PURE_MATRIX_IDENTITY);    // Our static identity matrix.