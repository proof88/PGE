...
private:
    ...
    bool test_wpn_load_weapon_bullet_subprojectiles_must_be_positive()
    {
        return test_helper_wpn_load_and_expect_exception(
            "gamedata/weapons/wpn_test_subprojectiles_must_be_positive.txt",
            "bullet_subprojectiles must be a positive value");
    }
    ...
    bool test_wpn_load_weapon_bullet_rel_distance_cannot_be_true_when_bullet_distance_max_0()
    {
        return test_helper_wpn_load_and_expect_exception(
