...
/*
    ###################################################################################
    PRREhwVideoDiscoverOpenGL_2_0.h
    This file is part of PRRE.
    Internal header.
    PRRE OpenGL 2.0 capabilities class.
    Made by PR00F88
...
/**
    PRRE OpenGL 2.0 capabilities class.
*/
class PRREhwVideoDiscoverOpenGL_2_0 :
    public PRREhwVideoDiscoverOpenGLbase
{
#ifdef PRRE_CLASS_IS_INCLUDED_NOTIFICATION
#pragma message("  PRREhwVideoDiscoverOpenGL_2_0 is included")
#endif

public:
    PRREhwVideoDiscoverOpenGL_2_0(
    ...
    virtual ~PRREhwVideoDiscoverOpenGL_2_0() {};
...
protected:
    ...
    PRREhwVideoDiscoverOpenGL_2_0(const PRREhwVideoDiscoverOpenGL_2_0&) {};
    PRREhwVideoDiscoverOpenGL_2_0& operator=(const PRREhwVideoDiscoverOpenGL_2_0&) { return *this; };
