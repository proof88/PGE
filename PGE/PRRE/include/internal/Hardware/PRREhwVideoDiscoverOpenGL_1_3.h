...
/*
    ###################################################################################
    PRREhwVideoDiscoverOpenGL_1_3.h
...
#pragma message("  PRREhwVideoDiscoverOpenGL_1_3 is included")
#endif

public:
    PRREhwVideoDiscoverOpenGL_1_3(
        ...
        const TPRREint&  nClrBits,
        const TPRREint&  nDpthBits,
        const TPRREint&  nStnclBits) :
    ...
    virtual ~PRREhwVideoDiscoverOpenGL_1_3() {};
...
protected:
    ...
    PRREhwVideoDiscoverOpenGL_1_3(const PRREhwVideoDiscoverOpenGL_1_3&) :
        nColorBits(nColorBits),
        nDepthBits(nDepthBits),
        nStencilBits(nStencilBits)
    {};
    PRREhwVideoDiscoverOpenGL_1_3& operator=(const PRREhwVideoDiscoverOpenGL_1_3&) { return *this; };
...
private:
    ...
    const TPRREint&  nColorBits;
    const TPRREint&  nDepthBits;
    const TPRREint&  nStencilBits;
    ...
    TPRREbool bSuppTexCompression;        /**< Is texture compression available? */
    TPRREbool bSuppVTC;                   /**< Is Volume Texture Compression available? */
    TPRREbool bSupp3Dc;                   /**< Is 3Dc/ATI2/DXN compression supported? */
    TPRREbool bSuppLATC;                  /**< Is Luminance-Alpha compression supported? */
    TPRREbool bSuppMultiTexturing;        /**< Is multitexturing available (fixed func. pipeline)? */
    TPRREint  nTMUcount;                  /**< Number of texture units. */
    TPRREbool bMSAAlevels[MSAA_SUPP_LEVELS_ARRAY_SIZE];  /**< Is the specified MSAA-level available? */
    TPRREint  nMSAAmaxLevel;              /**< Maximum level of MSAA. */
};