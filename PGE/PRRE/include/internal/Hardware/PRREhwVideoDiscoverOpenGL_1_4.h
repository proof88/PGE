...
/*
    ###################################################################################
    PRREhwVideoDiscoverOpenGL_1_4.h
    This file is part of PRRE.
    Internal header.
    PRRE OpenGL 1.4 capabilities class.
    Made by PR00F88
...
*/
class PRREhwVideoDiscoverOpenGL_1_4 :
    public PRREhwVideoDiscoverOpenGLbase
{
#ifdef PRRE_CLASS_IS_INCLUDED_NOTIFICATION
#pragma message("  PRREhwVideoDiscoverOpenGL_1_4 is included")
#endif

public:
    PRREhwVideoDiscoverOpenGL_1_4(
    ...
    virtual ~PRREhwVideoDiscoverOpenGL_1_4() {};
...
protected:
    ...
    PRREhwVideoDiscoverOpenGL_1_4(const PRREhwVideoDiscoverOpenGL_1_4&) {};
    PRREhwVideoDiscoverOpenGL_1_4& operator=(const PRREhwVideoDiscoverOpenGL_1_4&) { return *this; };

private:
    TPRREbool bSuppMultiDrawArrays;       /**< Is MultiDrawArrays supported? */
